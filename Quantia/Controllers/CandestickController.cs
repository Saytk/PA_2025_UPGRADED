...
namespace Quantia.Controllers
{
    ...
    public class CandlestickController : ControllerBase
    {
        ...
        {
            var apiUrl = $"http://127.0.0.1:8006/load-data?symbol={symbol}&start_date={start_date}&end_date={end_date}";
        ...
        {
            var url = $"http://127.0.0.1:8006/predict-latest?symbol={symbol}";
